...
import { QuestionsActions, setLoading, setFound, setSections, updateSection, setIsFound, setSearchQuery } from "./questions.action";

function* getSectionsWorker (action: RAction) {
    yield put(setIsFound(false));
